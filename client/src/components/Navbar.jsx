...
const Navbar = () => {
  ...
  return (
        <nav  className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-orange-50 relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
                    ...
                    <img className="h-4 w-4" src={images.search} alt='search' />
                </div>

                <div onClick={() => navigate("/cart")} className="relative cursor-pointer">
                    <img className="w-6 opacity-80" src={images.cart} alt="cart" />
               ...
               { !user ? (  <button onClick={()=> setUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition text-white rounded-full">
                ...
                (
                    <div className='relative group'>
                        <img className='w-7' src={images.profile} alt="profile" />
            ...
            <button onClick={() => open ? setOpen(false) : setOpen(true)} aria-label="Menu" className="">
                {/* Menu Icon SVG */}
                <img className="h-4 w-4" src={images.menu} alt="menu" />
            </button>
